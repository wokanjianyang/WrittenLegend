...
public class Dialog_Pet_Forge1 : MonoBehaviour
{
    ...
    private void Show()
    {
        ...
        long fee = PetConfigCategory.Instance.GetPetFee1(SelectPet.PetLevel.Data);
    ...
    public void OnClick_Ok()
    {
        ...
        long max = PetConfigCategory.Instance.GetPetFee1(SelectPet.PetLevel.Data);
    ...
    public void OnClick_Close()
    {
        ...
        Panel_Pet1 panel_Pet = this.GetComponentInParent<Panel_Pet1>();
        panel_Pet.Show();
    }
}
