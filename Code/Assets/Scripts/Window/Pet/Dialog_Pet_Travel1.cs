...
public class Dialog_Pet_Travel1 : MonoBehaviour
{
    ...
    public void Show()
    {
        ...
        if (SelectPet.RunTime > 0)
        {
            long runTime = TimeHelper.ClientNowSeconds() - SelectPet.RunTime;
    ...
    public void OnStop()
    {
        ...
        if (count >= 1)
        {
            ...
            GameProcessor.Inst.EventCenter.Raise(new ShowDropEvent() { Message = "粉宠打工奖励", Items = items });
        }
        else
        {
