...
public class Map_Babel_Myth : MonoBehaviour, IBattleLife
{
    ...
    public void OnBattleStart()
    {
        ...
        GameProcessor.Inst.EventCenter.AddListener<BabelMythStartEvent>(this.OnStart);
    ...
    public void OnStart(BabelMythStartEvent e)
    {
        long babel = GameProcessor.Inst.User.BabelMythData.Data + 1;
        ...
        GameProcessor.Inst.DelayAction(0.1f, () =>
        {
            ...
            GameProcessor.Inst.LoadMap(RuleType.BabelMyth, this.transform, param);
        });
    }
    ...
    {
        if (e.Time == MapTime && e.Type == RuleType.BabelMyth)
        {
            this.Exit();
        }
    }
    ...
    private void Exit()
    {
        ...
        GameProcessor.Inst.EventCenter.Raise(new BattlerEndEvent() { Type = RuleType.BabelMyth });
