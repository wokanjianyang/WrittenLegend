...
namespace Game
{
    public class Dialog_Detail_Steed : MonoBehaviour, IBattleLife
    {
        [LabelText("名称")]
        public Text TxtName;
        ...
        public void OnBattleStart()
        {
            ...
            GameProcessor.Inst.EventCenter.AddListener<ShowSteedDetailEvent>(this.OnShowEvent);
            this.rectTransform = this.transform.GetComponent<RectTransform>();
        }

        private void OnShowEvent(ShowSteedDetailEvent e)
        {
            ...
            List<KeyValuePair<int, double>> attrList = steed.GetBaseAttr().ToList();
            ...
            if (steed.Role > 0)
            {
                ...
                TxtSkillName.text = ConfigHelper.RoleName[steed.Role - 1] + "所有技能：";
                TxtSkillDes.text = "系数增幅" + steed.GetSkillPercent() + "%";
            }
