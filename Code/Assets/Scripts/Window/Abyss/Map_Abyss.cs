...
public class Map_Abyss : MonoBehaviour, IBattleLife
{
    ...
    public void OnBattleStart()
    {
        ...
        GameProcessor.Inst.EventCenter.AddListener<ShowAbyssInfoEvent>(this.OnShowInfo);
        GameProcessor.Inst.EventCenter.AddListener<AbyssStartEvent>(this.OnStart);
    ...
    public void OnStart(AbyssStartEvent e)
    {
        ...
        AbyssCopyConfig config = AbyssCopyConfigCategory.Instance.Get(e.Id);
        ...
        GameProcessor.Inst.DelayAction(0.1f, () =>
        {
            ...
            GameProcessor.Inst.LoadMap(RuleType.Abyss, this.transform, param);
        });
    }

    public void OnShowInfo(ShowAbyssInfoEvent e)
    {
        this.Txt_Time.text = "挑战时长：" + e.Time;
        this.Txt_Count.text = "剩余：" + e.Count;
    }

    private void OnBattleMsgEvent(BattleMsgEvent e)
    {
        if (e.Type != RuleType.Abyss)
        {
            return;
        }
    ...
    {
        if (e.Time == MapTime && e.Type == RuleType.Abyss)
        {
            this.Exit();
        }
    }
    ...
    private void Exit()
    {
        ...
        GameProcessor.Inst.EventCenter.Raise(new BattlerEndEvent() { Type = RuleType.Abyss });
