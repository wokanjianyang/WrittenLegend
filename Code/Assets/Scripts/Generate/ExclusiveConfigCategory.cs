...
namespace Game
{
    ...
    public class ExclusiveHelper
    {
        ...
        public static ExclusiveItem BuildCycle4(int configId, int qualityRate, int seed)
        {
            //if (seed < 0)

            ExclusiveConfig config = ExclusiveConfigCategory.Instance.Get(configId);

            int quality = RandomNewQualityCycle4(qualityRate);
        ...
        {
            int[] rates = { 1, 4, 16, 100, 1000, 10000, 100000, 600000, 900000 };
