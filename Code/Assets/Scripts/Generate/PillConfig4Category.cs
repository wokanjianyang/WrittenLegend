...
namespace Game
{
    ...
    public partial class PillConfig4Category
    {
        ...
        public Dictionary<int, double> ParseLevel(long total)
        {
            ...
            foreach (PillConfig4 config in this.list)
            {
        ...
        public PillConfig4 GetByLevel(long level)
        {
    ...
    public partial class PillConfig4
    {
