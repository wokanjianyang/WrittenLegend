...
public class Monster_Abyss : APlayer
{
    AbyssCopyConfig config;
    ...
    private string[] NameList = { "深渊影卫", "深渊死骑", "深渊恶魔", "深渊魔王", "深渊主宰" };

    public Monster_Abyss(int mapId, int quality)
    {
        this.GroupId = 2;
        this.RuleType = RuleType.Myth;
        this.Quality = quality;

        config = AbyssCopyConfigCategory.Instance.Get(mapId);
    ...
    private int[] SkillList = new int[] { 2007 };
