...
namespace Game
{
    public class ConfigHelper
    {
        ...
        public const int Version = 443;

        public const long PackTime = 1778985913; //打包时间，防止作弊

        public const long PackEndTime = 1780713913; //超过此时间,游戏不能使用，需要更新
        ...
        public const int Infinit_Max = 7500;
