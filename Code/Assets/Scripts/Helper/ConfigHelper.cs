...
namespace Game
{
    public class ConfigHelper
    {
        ...
        public const long Max_Level = 60000; //最大人物等级和强化等级

        public const long Max_Level_Refine = 300; //最大精练等级
        ...
        public const long PackTime = 1709774345; //打包时间，防止作弊

        public const long PackEndTime = 1711502345; //超过此时间,游戏不能使用，需要更新
