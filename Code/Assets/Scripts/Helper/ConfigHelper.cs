...
namespace Game
{
    public class ConfigHelper
    {
        ...
        public const int Version = 437;

        public const long PackTime = 1775115781; //打包时间，防止作弊

        public const long PackEndTime = 1776843781; //超过此时间,游戏不能使用，需要更新
        ...
        public const int BabelMax = 60000;
