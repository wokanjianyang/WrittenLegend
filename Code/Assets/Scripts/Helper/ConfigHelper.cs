...
namespace Game
{
    public class ConfigHelper
    {
        ...
        public const int Version = 451;

        public const long PackTime = 1785205357; //打包时间，防止作弊

        public const long PackEndTime = 1789525357; //超过此时间,游戏不能使用，需要更新
        ...
        public static string[] UnitList = { "万", "亿", "兆", "京", "垓", "秭", "穰", "沟", "涧", "正", "载", "极", "恒", "河", "沙", "阿", "僧", "祇"
                ...
                ,"露","结","为","霜","金","生","丽","水","剑","号","巨","阙","珠","称","夜","光"
                ,"果","珍","李","柰","菜","重","芥","姜","鳞","潜","羽","翔","龙","师","火","帝"}; // ，， ，鸟官人皇

        public const int MapStartId = 1000;

        public const int DefendHp = 2000; //防守塔默认血量
        public const int DefendMaxLevel = 9; //守沙难度
        ...
        public const int BabelMax = 65000;
        public const int BabelMythMax = 2000;
        public const int BabelMythCount = 100;

        public const int PillMax = 20;
        public const int PillMax2 = 15;
        public const int PillMax3 = 10;
