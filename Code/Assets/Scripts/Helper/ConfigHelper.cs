...
namespace Game
{
    public class ConfigHelper
    {
        ...
        public const long PackTime = 1766207875; //打包时间，防止作弊

        public const long PackEndTime = 1767935875; //超过此时间,游戏不能使用，需要更新
        ...
        public static int[] BaseAttrIdList = { 0, 1, 2, 3, 4, 5, 7, 21, 22, 25, 39, 40, 42 };
