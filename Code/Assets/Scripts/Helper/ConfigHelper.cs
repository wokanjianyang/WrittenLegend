...
namespace Game
{
    public class ConfigHelper
    {
        ...
        public const int Version = 453;

        public const long PackTime = 1786183682; //打包时间，防止作弊

        public const long PackEndTime = 1787911682; //超过此时间,游戏不能使用，需要更新
        ...
        public const int Infinit_Max = 9000;
