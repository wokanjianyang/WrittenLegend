...
public class ProGifRecorder
{
	...
	{
		if (recorderCom != null)
			recorderCom.SetTransparent(color32, transparentColorRange);
	}
    ...
    {
        if (recorderCom != null)
            recorderCom.SetTransparentExtras(enableExtraSettings);
    }

    public void SetTransparentExtras(bool enableExtraSettings, int targetWidth, int targetHeight)
    {
        if (recorderCom != null)
            recorderCom.SetTransparentExtras(enableExtraSettings, targetWidth, targetHeight);
    }
