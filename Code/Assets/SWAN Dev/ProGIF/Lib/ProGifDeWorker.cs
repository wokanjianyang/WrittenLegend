...
internal sealed class ProGifDeWorker
{
	...
	/// <summary> Create the decoder worker as a singleton, queue all gif decoders in one separated thread. </summary>
	internal static ProGifDeWorker GetInstance(ThreadPriority priority = ThreadPriority.BelowNormal, bool isBackgroundThread = false)
	{
