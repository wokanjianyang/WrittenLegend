...
namespace SDev.WWO_API
{
    public class MarineHistoryAPI
    {
        ...
        [Serializable]
        public class MarineHistoryQuery
        {
            [Header("[ Required ]")]
            ...
            [Tooltip("The date to return the weather for (past). Valid values: yyyy-MM-dd(e.g. 2021-05-15)")]
            public string date;
            ...
            [Tooltip("If you wish to retrieve weather between two dates, use this  parameter to specify the ending date." +
                ...
                "Valid values: yyyy-MM-dd(e.g. 2021-05-21)")]
